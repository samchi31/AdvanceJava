...
public class T02LambdaTest {
	public static void main(String[] args) {
		 ...
		 * 		예) (a, b) -> { return a+b; }    또는	(a,b) -> return a+b
		 * 
		...
		System.out.println(lam6.test(20, 50));
		
		LambdaInterface3 lam7 = 
				(x, y) -> {
					return x + y;
				};
		System.out.println(lam7.test(80, 50));
		
		LambdaInterface3 lam8 = 
				(x, y) -> x + y;
		System.out.println(lam8.test(100, 200));
		
		LambdaInterface3 lam9 = 
				(x, y) -> x > y ? x : y;
		System.out.println(lam9.test(100, 200));
		
		//consumer 사용
		Consumer<Integer> lam10 = 
				z -> {
