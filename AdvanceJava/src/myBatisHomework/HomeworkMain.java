package myBatisHomework;

import java.util.List;
import java.util.Scanner;

import myBatisHomework.service.IMemoService;
import myBatisHomework.service.MemoServiceImpl;
...
public class HomeworkMain {
	...
	public static void main(String[] args) {
		HomeworkMain memObj = new HomeworkMain();
		memObj.start();
	}
}
