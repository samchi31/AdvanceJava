...
/**
 * Class오브젝트(클래스 정보를 담고있는)를 생성하기
 */
public class T01ClassObjectCreationTest {
/*
 * Java Reflection 
 * 
 * 1. 자바 리플렉션은 런타임 시점에 클래스 또는 멤버변수, 메서드, 생성자 등에 대한 정보를 가져오거나 수정할 수 있고, 새로운 객체를 생성하거나 메서드를 실행할 수 있다
 ...
 */
	public static void main(String[] args) throws ClassNotFoundException {
		...
		Class<?> klass = Class.forName("javaAnnotation.Service");
