 ...
 * - 쿠키를 사용할 때보다 보안이 향상된다 (서버에 정보가 저장된기 때문에)
 * - 세션객체를 가져오는 방법
 *   HttpSession session = request.getSession(boolean)
 *   		boolean = true인 경우 => 세션 객체가 존재하지 않으면 새로 생성 매개변수 생략 시 true
...
//		session.setMaxInactiveInterval(30); // 세션 n초 있다가 삭제	
		//////////////////////////////////////////////////
